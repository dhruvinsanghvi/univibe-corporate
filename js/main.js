...
var x = $(".jumbotron").height();
  if($(window).scrollTop() > x ){
    ...
    //$(".nav-tabs").css({ "position":"fixed", "z-index":1000, "background-color":"#fff","top":"80px"});
 
  } else {
    console.log("else");
    $(".navbar-default").css("background-color", "transparent");
    $(".navbar-default .navbar-nav > li > a").css("color", "#ffffff");
    //$(".nav-tabs").css({"top": 0, "position":"static", "z-index":0, "background-color":"#fff","left":"0","top":"0px"});
